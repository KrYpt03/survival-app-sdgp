          ...
          <View style={styles.header}>
            ...
            <View style={styles.menuIcon}>
              <ImageBackground
                ...
                source={require("../assets/images/598abff4-864b-4377-8e2a-cd4e76efea0d.png")}
                resizeMode="cover"
              />
              <ImageBackground
                style={[styles.menuLine, styles.menuLineMiddle]}
                source={require("../assets/images/66720931-0cfe-47fc-8b62-191ae762edc6.png")}
                resizeMode="cover"
              />
              <ImageBackground
                style={[styles.menuLine, styles.menuLineBottom]}
                source={require("../assets/images/c64db674-2ded-4d72-a275-ced80266cff2.png")}
                resizeMode="cover"
              />
            </View>
          </View>
          <View style={styles.logoContainer}>
            <ImageBackground style={styles.largeLogo} source={require("../assets/images/Logo2.png")} resizeMode="contain" />
          </View>
        </View>
      </ImageBackground>
    </SafeAreaView>
